...
## Layers
The meta feeds into two layers, of 64 neurons each, whilst the board image feeds into 2 layers of a CNN, of 32 and 64 channels respectively. The outputs of both networks are then fed through two layers of 512 ad 256 respectively.

Here is an ascii overview of the decision structure:
```bash
   Meta       Board
     ↓          ↓
